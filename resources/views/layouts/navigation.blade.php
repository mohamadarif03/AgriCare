<nav
    class="sticky top-0 w-full z-50 bg-white/95 backdrop-blur-md dark:bg-slate-900/95 border-b border-orange-100/50 dark:border-slate-800 shadow-sm shadow-orange-900/5 font-['Plus_Jakarta_Sans']">
    <div class="px-4 xl:px-6 w-full max-w-[1600px] mx-auto">
        <div class="flex items-center justify-between h-16 gap-4">
            ...
            <div class="hidden xl:flex items-center gap-1 flex-1 justify-center">
                <a href="{{ route('dashboard') }}"
                    class="px-3 py-2 text-sm font-semibold transition-colors whitespace-nowrap {{ request()->routeIs('dashboard') ? 'text-orange-700 dark:text-orange-400 border-b-2 border-orange-700 dark:border-orange-400' : 'text-slate-600 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-300' }}">Dashboard</a>
                ...
                <a href="{{ route('ai_reccomendation') }}"
                    class="px-3 py-2 text-sm font-semibold transition-colors whitespace-nowrap {{ request()->routeIs('ai_reccomendation') ? 'text-orange-700 dark:text-orange-400 border-b-2 border-orange-700 dark:border-orange-400' : 'text-slate-600 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-300' }}">Rekomendasi</a>
            </div>

            <!-- Kanan: User Area -->
            <div class="flex items-center gap-3 shrink-0">
                <button
                    class="relative p-2 text-slate-500 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors rounded-full hover:bg-slate-100 dark:hover:bg-slate-800">
                ...
                <div class="relative group cursor-pointer">
                    <div
                        class="w-10 h-10 rounded-full overflow-hidden border-2 border-orange-100 dark:border-orange-900 hover:border-orange-300 transition-colors">
                    ...
                    <div
                        ...
                        <div class="py-2 flex flex-col">
                            <a href="#"
                                class="px-4 py-2.5 text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-orange-50 dark:hover:bg-slate-700 hover:text-orange-700 dark:hover:text-orange-400 flex items-center gap-3"><span
        ...
        <div
            ...
            <a href="{{ route('dashboard') }}"
                class="text-sm font-semibold whitespace-nowrap {{ request()->routeIs('dashboard') ? 'text-orange-700 dark:text-orange-400 border-b-2 border-orange-700 dark:border-orange-400 pb-1' : 'text-slate-600 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-300' }}">Dashboard</a>
            <a href="{{ route('calender_planning') }}"
            ...
            <a href="{{ route('tanibot') }}"
                ...
                AI</a>
            <a href="{{ route('ai_reccomendation') }}"
                class="text-sm font-semibold whitespace-nowrap {{ request()->routeIs('ai_reccomendation') ? 'text-orange-700 dark:text-orange-400 border-b-2 border-orange-700 dark:border-orange-400 pb-1' : 'text-slate-600 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-300' }}">Rekomendasi</a>
        </div>
    </div>
</nav>
