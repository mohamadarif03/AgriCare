    ...
    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200 dark:border-slate-700">
        <div class="prose prose-lg prose-slate dark:prose-invert max-w-none">
            ...
            <ul class="list-disc pl-6 text-slate-600 dark:text-slate-300 space-y-2 mb-6">
                ...
                <li>TaniSiaga berhak untuk menangguhkan atau menghapus akun yang melanggar ketentuan atau terindikasi melakukan tindakan penyalahgunaan.</li>
            </ul>
            ...
            <p class="text-slate-600 dark:text-slate-300 mb-6">
                Seluruh rekomendasi yang diberikan oleh TaniSiaga dihasilkan oleh algoritma Artificial Intelligence berdasarkan data cuaca, iklim, dan pasar yang tersedia secara publik (BMKG, Kementerian Pertanian, dll). Kami tidak menjamin keakuratan absolut dari prediksi tersebut. Kerugian materil maupun imateril yang timbul akibat keputusan bertani yang diambil sepenuhnya merupakan tanggung jawab pengguna.
            </p>

            <h2 class="text-2xl font-bold text-slate-800 dark:text-white mt-10 mb-4">5. Kekayaan Intelektual</h2>
            <p class="text-slate-600 dark:text-slate-300 mb-6">
                Seluruh desain, logo, algoritma, dan konten yang terdapat pada TaniSiaga dilindungi oleh hak cipta. Pengguna dilarang untuk menyalin, mereproduksi, atau mendistribusikan ulang elemen-elemen tersebut tanpa izin tertulis dari pihak TaniSiaga.
            </p>

            <h2 class="text-2xl font-bold text-slate-800 dark:text-white mt-10 mb-4">6. Perubahan Ketentuan</h2>
            <p class="text-slate-600 dark:text-slate-300 mb-6">
                TaniSiaga berhak mengubah syarat dan ketentuan ini kapan saja. Perubahan akan diinformasikan melalui halaman ini atau melalui notifikasi akun. Penggunaan layanan yang berkelanjutan setelah perubahan dianggap sebagai persetujuan terhadap syarat dan ketentuan yang baru.
            </p>
