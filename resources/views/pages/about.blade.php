...
<div class="px-4 xl:px-6 w-full max-w-[1200px] mx-auto py-8 lg:py-12 flex-1">
    ...
    <div class="mb-10 md:mb-16 text-center">
        <h1 class="text-4xl md:text-5xl font-extrabold text-green-800 dark:text-green-400 tracking-tight mb-4">Tentang TaniSiaga</h1>
    ...
    <div class="space-y-12">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-sm border border-green-100 dark:border-slate-700">
            ...
            <div class="prose prose-lg prose-green dark:prose-invert max-w-none text-slate-600 dark:text-slate-300">
                <p>
                    <strong>TaniSiaga</strong> hadir dengan visi untuk memodernisasi sektor pertanian Indonesia melalui pemanfaatan teknologi kecerdasan buatan (AI) dan data real-time. Kami percaya bahwa setiap petani berhak mendapatkan akses informasi yang akurat dan tepat waktu untuk mengoptimalkan hasil panen mereka.
                </p>
                <p>
                    Misi kami adalah:
                </p>
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-slate-800 dark:to-slate-800/80 rounded-3xl p-8 md:p-12 shadow-sm border border-green-100 dark:border-slate-700">
            <div class="text-center mb-10">
                ...
                <p class="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
                    Kami terus berinovasi dan berkolaborasi dengan berbagai pihak untuk memastikan TaniSiaga selalu relevan dengan kebutuhan pertanian masa depan.
                </p>
            </div>
