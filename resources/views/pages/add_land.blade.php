...
function showResult(el, success, msg) {
    el.classList.remove('hidden','bg-orange-50','border-orange-200','text-orange-800','bg-red-50','border-red-200','text-red-700');
    el.classList.add(success ? 'bg-orange-50' : 'bg-red-50', 'border',
        success ? 'border-orange-200' : 'border-red-200',
        success ? 'text-orange-800'   : 'text-red-700');
    el.innerHTML = msg;
}
