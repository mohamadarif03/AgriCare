    ...
    <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200 dark:border-slate-700">
        <div class="prose prose-lg prose-slate dark:prose-invert max-w-none">
            ...
            <p class="lead text-xl text-slate-600 dark:text-slate-300 mb-8">
                Privasi Anda sangat penting bagi kami. Kebijakan Privasi ini menjelaskan bagaimana TaniSiaga mengumpulkan, menggunakan, dan melindungi informasi pribadi Anda saat menggunakan layanan kami.
            </p>
            ...
            <ul class="list-disc pl-6 text-slate-600 dark:text-slate-300 space-y-2 mb-6">
                <li>Menyediakan, memelihara, dan meningkatkan kualitas layanan TaniSiaga.</li>
